...
const { sendInterviewResultEmail } = require("../services/skillLabEmail.js");
...
router.post("/interviews/:attemptId/submit", async (req, res, next) => {
  ...
  try {
    ...
    try {
      emailDelivery = await sendInterviewResultEmail({
        student: req.skillLabUser,
        attemptId: attempt.id,
        roleTitle: attempt.skill_lab_roles?.title || "Splunk",
        score,
        outcome,
        offer: jobOffer,
      });
    } catch (emailError) {
      console.error("Unexpected interview email error:", emailError.message);
    }
...
// } = require("../services/skillLabEmail.js");
...
// async function sendPassedInterviewEmail({ student, roleTitle, score, offer }) {
//   if (!process.env.RESEND_API_KEY || !process.env.RESEND_FROM_EMAIL) {
//     console.warn("Skill Lab pass email skipped: Resend environment variables are missing.");
//     return false;
//   }
...
//   const safeCompany = escapeHtml(offer.company);

//   const { error } = await resend.emails.send({
//     from: process.env.RESEND_FROM_EMAIL,
//     to: [student.email],
//     subject: `You passed your TO Skill Lab ${roleTitle} interview`,
//     html: `
...
//             <div style="font-size:13px;letter-spacing:2px;color:#d8b4fe;font-weight:700">TO SKILL LAB</div>
//             <h1 style="margin:12px 0 0;font-size:30px">Congratulations, ${safeName}!</h1>
//           </div>
//           <div style="padding:30px">
//             <p style="font-size:17px;line-height:1.7;margin-top:0">You passed your <strong>${safeRole}</strong> interview with a score of <strong>${score}%</strong>.</p>
//             <div style="background:#ecfdf5;border:1px solid #a7f3d0;border-radius:14px;padding:20px;margin:22px 0">
//               <div style="font-size:12px;letter-spacing:1.5px;color:#047857;font-weight:700">VIRTUAL JOB OFFER</div>
//               <h2 style="margin:8px 0">${safeCompany}</h2>
//               <p style="margin:0;line-height:1.6">Position level: <strong>${escapeHtml(offer.job_level)}</strong><br>Virtual salary: <strong>${Number(offer.virtual_salary).toLocaleString()} TO Credits</strong></p>
//             </div>
//             <p style="line-height:1.7">Return to TO Skill Lab to review your result. The next career stage will allow you to accept the offer and complete professional tasks.</p>
//             <a href="https://www.to-analytics.com/toskillab" style="display:inline-block;margin-top:10px;background:#4f46e5;color:white;text-decoration:none;padding:14px 22px;border-radius:10px;font-weight:700">Open TO Skill Lab</a>
//             <p style="margin-top:26px;font-size:12px;color:#64748b">This is a simulated learning offer and virtual currency. It is not an offer of real-world employment or cash payment.</p>
//           </div>
//         </div>
//       </div>
//     `,
...
//   if (error) {
//     console.error("Resend Skill Lab email failed:", error);
//     return false;
//   }
...
//       try {
//         emailSent = await sendPassedInterviewEmail({
//           student: req.skillLabUser,
//           roleTitle: attempt.skill_lab_roles?.title || "Splunk",
//           score,
//           offer: jobOffer,
//         });
//       } catch (emailError) {
//         console.error("Skill Lab pass email error:", emailError);
//       }
//     }
